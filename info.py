...
BOT_TOKEN = environ.get('BOT_TOKEN', "8317688074:AAHjKpFG2Wj-0XkAKU2fLrh2LFyd1v--ceM")    # Bot token from @BotFather
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003273428258'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003273428258'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003297786800')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003146799370')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003146799370")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003214017673")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrtechmalayalam1:kMKvlEXIvhYC2K5J@cluster0.feas8nb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
